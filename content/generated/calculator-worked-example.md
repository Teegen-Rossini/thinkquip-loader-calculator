...
Assumptions (the app's defaults; every one is adjustable on screen): 8 h/day × 6 days/week × 50 weeks/year = 2 400 operating hours per year; operation slider 75 (Normal); electricity R2,80/kWh and diesel R23,50/L (placeholder prices); fuel included in the rate; moderately controlled site (fuel-theft uplift θ = 3,5% on diesel fuel); fleet of 1; all figures excluding VAT.

## Year-0 running cost per operating hour
- Electric SW956E: 32.5 kWh/h × R2,80/kWh = R91,00/h (no mechanical service).
- Diesel SYL956H5: 13.0 L/h × R23,50/L × 1.035 theft uplift = R316,19/h fuel, plus R29/h routine service = R345,19/h total.
- Year-0 hourly saving of electric over diesel: R254,19 per operating hour (before escalation; electricity escalates +8%/yr vs diesel fuel +6%/yr).
...
At 2 400 h/year, the 30,000 h battery replacement lands around year 12,5. Today's cost R1 120 000 declining 5%/year projects to about R589 879 at that point. This is beyond the first owner's typical lifecycle and is NOT included in the 0–15 000 h comparison or displayed anywhere in the tool.

Different inputs (hours, prices, slider, theft level, fleet size, VAT) change all of these figures — the website recalculates live, and the printed brochure uses whatever the user set on screen.
